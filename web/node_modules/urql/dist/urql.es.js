...
function useSource(input, transform) {
  ...
  useEffect((function() {
    return subscribe(_ref3)(transform(input$, state)).unsubscribe;
  }), [ input$ ]);
...
import { toPromise, makeSubject, concat, map, fromValue, subscribe, takeWhile, share, scan, switchMap } from "wonka";
