...
function E(a, e, g) {
  var b, d, l, p, c = t(a.resolveFieldByKey(e, g));
  if (!c) {
    return null;
  }
      ...
      for (A = null, m = [], u = [], q = [], n = [], k = _extends({}, r), x = 0; x < w; x++) {
        ...
        if (null !== (h = h.arguments) && D(c, h) && null !== (f = E(b, a, f))) {
          if ("inwards" === e && "number" == typeof h.last && "number" == typeof h.first) {
            ...
            k.startCursor = f.pageInfo.startCursor, k.hasPreviousPage = f.pageInfo.hasPreviousPage) : ("number" == typeof h.last ? (u = v(b, u, f.edges), 
            n = C(n, f.nodes)) : (m = v(b, m, f.edges), q = C(q, f.nodes)), k = f.pageInfo);
          }
  ...
  return function(a, c, p, w) {
    ...
    if (0 !== (l = (m = p.inspectFields(a = w.parentKey).filter((function(a) {
      ...
      for (q = new Set, n = [], k = null, x = 0; x < l; x++) {
        f = (h = m[x]).fieldKey;
        if (null !== (h = h.arguments) && e(c, h) && (f = p.resolveFieldByKey(a, f), h = h[g], 
        null !== f && 0 !== f.length && "number" == typeof h)) {
